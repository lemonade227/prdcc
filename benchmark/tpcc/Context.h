...
enum class TPCCWorkloadType { NEW_ORDER_ONLY, PAYMENT_ONLY, DELIVERY_ONLY, MIXED };
...
public:
  ...
  Context get_single_partition_context() const {
    ...
    c.deliveryCrossPartitionProbability = 0;
  ...
  Context get_cross_partition_context() const {
    ...
    c.deliveryCrossPartitionProbability = 100;
  ...
  int deliveryCrossPartitionProbability = 1;  // out of 100
